...
function crb_add_theme_readme() {
	$url = str_replace( '\\', '/', str_replace( untrailingslashit( ABSPATH ), site_url(), dirname(__FILE__) ) );
	wp_register_style('theme-help-style', $url . '/theme-help.css', array(), '0.1', 'screen');
	wp_enqueue_style('theme-help-style');
	add_menu_page(__('Theme Help', 'crb'), __('Theme Help', 'crb'), 'administrator', 'theme-readme', 'crb_include_theme_help', 'dashicons-editor-help');
}
