...
<div class="article article-head">
		<h1 class="pageTitle">Add Card</h1>
	</div>
	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row" style="padding-top: 0px">
				...
				<input type="submit" class="woocommerce-Button woocommerce-Button button" id="place_order" value="<?php esc_attr_e( 'Add Payment Method', 'woocommerce' ); ?>" />
