...
<div class="intro" style="border: 0px; padding-right: 20px">
    <div class="intro-content">
			<h1>Change Password</h1>
		</div>

<div class="section" style="font: Roboto; font-size: 16px">
...
<!--	<fieldset style="padding-left: 15px; padding-right: 15px">
